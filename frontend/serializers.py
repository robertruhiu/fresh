...
from frontend.models import Experience, Portfolio,  AssessmentReport, Assessment, TestCenter, \
    Resources, Cohort,Report
...
class AssesmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Assessment
        fields = (
        'id', 'candidate', 'project', 'stage', 'projectstarttime', 'frameworktested', 'test_center', 'test_choice',
        'csa', 'portfolio')
